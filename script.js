...
var toggle1Image = browser.runtime.getURL("images/toggle1.png");
...
youtubeLinks.forEach(function(element){
    ...
    element.insertAdjacentHTML('afterend',"<img id='button"+randomNum+"' style='display: inline;width:20px;' src='"+toggle1Image+"'>");
    var toggle = document.getElementById('button'+randomNum);
    toggle.addEventListener("click", function() {
        if(document.getElementById('frame'+id)){
        toggle.src = browser.runtime.getURL("images/toggle1.png");
        document.getElementById('frame'+id).remove();
        } else {
        toggle.src = browser.runtime.getURL("images/toggle2.png");
